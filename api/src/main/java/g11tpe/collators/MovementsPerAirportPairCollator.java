...
public class MovementsPerAirportPairCollator implements Collator<Map.Entry<Long, List<String>>, List<MutablePair<Long, MutablePair<String, String>>>> {
    @Override
    public List<MutablePair<Long, MutablePair<String, String>>> collate(Iterable<Map.Entry<Long, List<String>>> values ) {
        List<MutablePair<Long, MutablePair<String, String>>> list = new LinkedList<>();
